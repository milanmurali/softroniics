...
export const Business = () => {
    return (
        <div className='font-sans'>
            ...
            <div className='mainblue sm:h-screen md:h-screen lg:h-screen xl:h-screen w-screen bg-[#145cd4]'>
                ...
                <div className='con1 text-white mx-6 my-20 flex flex-wrap items-center justify-around'>
                    <div className='texts w-screen sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4'>
                        ...
                        <div className='flex justify-between'>
                            <Link to="/bislogin" className="bg-white text-[#145cd4] font-bold px-4 rounded-md hover:bg-gray-300 flex items-center">GET STARTED</Link>
                            <a href="https://www.youtube.com/watch?v=xvFZjo5PgG0" className=" text-lg mx-5 p-1 flex items-center rounded border border-transparent hover:border hover:border-white ">
            ...
            <div className='mainwhite h-screen w-screen flex items-center'>
                <div className='con2 text-black flex flex-wrap justify-around items-center'>
                    ...
                    <div className='texts2 mx-6 my-10 w-full sm:w-screen md:w-3/4 lg:w-1/2 xl:w-1/3'>
                        ...
                        <Link to="/bisabout" class=" bg-[#145cd4] text-white font-bold py-2 px-4 rounded-md hover:bg-white hover:text-black ">
                                Who We Are
                            </Link>
